    ...
    <div class="row login">
        <form class="col-md-4" @submit.prevent="submitForm">
            ...
            <div class="form-group">
                ...
                <small id="emailHelp" v-if="!form.errors.has('email')" class="form-text text-muted">We'll never share your email with anyone else.</small>
            ...
            <div class="form-group">
                ...
                <input type="text"
                       ...
                       class="form-control" id="fName" aria-describedby="fname" placeholder="Enter First Name">
            ...
            <div class="form-group">
                ...
                <input type="text"
                       ...
                       class="form-control" id="lName" aria-describedby="lName" placeholder="Enter Last Name">
